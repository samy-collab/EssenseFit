    ...
    <section className="space-y-8">
      <div className="relative overflow-hidden rounded-lg bg-theme-hero px-6 py-12 text-white shadow-[0_24px_70px_var(--shadow-strong)] sm:px-8">
        ...
        <div className="relative max-w-3xl">
          <p className="inline-flex rounded-full border border-white/25 bg-white/12 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-white/86 backdrop-blur">Catalogo</p>
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-white/78">Pecas femininas em modelos reais para enxergar caimento, proporcao, cor e acabamento antes de escolher.</p>
        </div>
      </div>
